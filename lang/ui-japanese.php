...
$months_m = array("1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月");
$wkDays = array("日曜日","月曜日","火曜日","水曜日","木曜日","金曜日","土曜日","日曜日");
$wkDays_l = array("日","月","火","水","木","金","土","日");
$wkDays_m = array("日","月","火","水","木","金","土","日");
$wkDays_s = array("日","月","火","水","木","金","土","日");
...
"hdr_view_1" => "Year",
"hdr_view_2" => "Month",
"hdr_view_3" => "Month(土日除外)",
"hdr_view_4" => "Week",
"hdr_view_5" => "Week(土日除外)",
"hdr_view_6" => "Day",
"hdr_view_7" => "予定",
"hdr_view_8" => "変更履歴",
"hdr_view_9" => "カテゴリ別",
...
"hdr_import_usr" => "ユーザ登録 (CSV)",
"hdr_export_usr" => "ユーザ照会 (CSV)",
"hdr_import_csv" => "イベント登録 (CSV)",
"hdr_import_ics" => "イベント登録 (iCal)",
"hdr_export_ics" => "イベント照会 (iCal)",
"hdr_styling" => "カラースキーム",
...
"hdr_button_contact" => "お問い合わせ",
"hdr_contact" => "Contact the administrator",
"hdr_button_tnails" => "サムネイル",
...
"con_message" => "本文",
"con_send_msg" => "送信",
"con_fill_in_all_fields" => "すべて必須項目です。",
